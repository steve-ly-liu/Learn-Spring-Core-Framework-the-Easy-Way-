...
import com.example.customautowireconfigurersample.config.JavaConfig;
...
public class CustomAutowireConfigurerSampleApplication {

    public static void main(String[] args) {
        SpringApplication.run(CustomAutowireConfigurerSampleApplication.class, args);
